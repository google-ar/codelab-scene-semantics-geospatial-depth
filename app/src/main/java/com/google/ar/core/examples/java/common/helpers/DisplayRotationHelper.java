...
public final class DisplayRotationHelper implements DisplayListener {
   ...
   * {@link #onSurfaceChanged(int, int)} call or by {@link #onDisplayChanged(int)} system callback.
   * This function should be called explicitly before each call to {@link Session#update()}. This
